...
if (
    ...
    console.log("🎯 Recommendation request detected");
    console.log("👤 Recipient:", yamGiftMemory.recipient);
    console.log("🎉 Occasion:", yamGiftMemory.occasion);
    console.log("💰 Budget:", yamGiftMemory.budget);
    console.log("📦 Products:", typeof yamGiftProducts);

    const recommendation = buildGiftRecommendation();
